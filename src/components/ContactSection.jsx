      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-7">
        ...
        >
          ...
          <a
            ...
            className="wax-gold-btn inline-flex items-center gap-2 border-2 border-gold bg-transparent px-6 py-2 rounded font-display text-xs font-bold uppercase tracking-[0.2em] text-maroon-dark hover:bg-gold/30"
          >
        ...
        >
          <div className="w-full grow min-h-75 overflow-hidden rounded">
            <iframe
              ...
              width="100%"
              height="100%"
              style={{ border: 0, minHeight: 300, filter: 'sepia(.6) saturate(.8) contrast(.9)' }}
              allowFullScreen
              loading="lazy"
          ...
          <div className="pt-3 text-center">
            ...
            <p className="text-muted">4–6 December</p>
          </div>
        </motion.div>
      </div>
    </section>
